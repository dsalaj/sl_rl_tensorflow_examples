...
def plot_results(N_trial,N_trial_test,reward_list,Q_table, env):
    ...
    ax_list[0, 0].plot(reward_list[:N_trial], lw=2)
    ...
    # plot the reward over time
    r_av = np.mean(reward_list[N_trial:])
    ax_list[0, 1].plot(reward_list[N_trial:], lw=2)
